...
namespace LanchesBufa.Areas.Admin.Controllers
{
    [Area("Admin")]
    ...
    public class AdminLanchesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("LancheId,Nome,DescricaoCurta,DescricaoDetalhada,ImagemUrl,ImagemThumbnailUrl,Preco,IsLanchePreferido,EmEstoque,CategoriaId")] Lanche lanche)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("LancheId,Nome,DescricaoCurta,DescricaoDetalhada,ImagemUrl,ImagemThumbnailUrl,Preco,IsLanchePreferido,EmEstoque,CategoriaId")] Lanche lanche)
        {
